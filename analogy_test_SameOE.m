...
analogy_data_file = [filename_prefix '_SameOE_data.txt'];
    ...
    for feat1 = 1 : num_features_to_learn
        ...
        for feat2 = setdiff(1 : num_features_to_learn, feat1)
            ...
            [false_dist, ABsortorder, CDsortorder, AB_murst, CD_murst] = ...
                analogy_importance_mapping(feat1_higher_mu, feat2_higher_mu, ...
                feat3_lower_mu, feat4_lower_mu, feat1_higher_sigma, feat2_higher_sigma, feat3_lower_sigma, feat4_lower_sigma);
            ...
            fprintf('%s : %s :: %s : %s, dist = %f\n', ...
                get_relation_name(feat1, true), get_relation_name(feat2, true), ...
                get_relation_name(feat3, false), get_relation_name(feat4, false), false_dist);
            
            fprintf(datafile, '%s : %s :: %s : %s, dist = %f, %d\n', ...
                get_relation_name(feat1, true), get_relation_name(feat2, true), ...
                get_relation_name(feat3, false), get_relation_name(feat4, false), false_dist, true_dist < false_dist);
            
            
            [false_dist, ABsortorder, CDsortorder, AB_murst, CD_murst] = ...
                analogy_importance_mapping(feat1_higher_mu, feat2_higher_mu, ...
                feat4_lower_mu, feat3_lower_mu, feat1_higher_sigma, feat2_higher_sigma, feat4_lower_sigma, feat3_lower_sigma);
            ...
            fprintf('%s : %s :: %s : %s, dist = %f\n', ...
                get_relation_name(feat1, true), get_relation_name(feat2, true), ...
                get_relation_name(feat4, false), get_relation_name(feat3, false), false_dist);
            
            fprintf(datafile, '%s : %s :: %s : %s, dist = %f, %d\n', ...
                get_relation_name(feat1, true), get_relation_name(feat2, true), ...
                get_relation_name(feat4, false), get_relation_name(feat3, false), false_dist, true_dist < false_dist);
            fprintf('\n'); fprintf(datafile,'\n');
            ...
            [false_dist, ABsortorder, CDsortorder, AB_murst, CD_murst] = ...
                analogy_importance_mapping(feat1_lower_mu, feat2_lower_mu, ...
                feat3_higher_mu, feat4_higher_mu, feat1_lower_sigma, feat2_lower_sigma, feat3_higher_sigma, feat4_higher_sigma);
            ...
            fprintf('%s : %s :: %s : %s, dist = %f\n', ...
                get_relation_name(feat1, false), get_relation_name(feat2, false), ...
                get_relation_name(feat3, true), get_relation_name(feat4, true), false_dist);
            
            fprintf(datafile, '%s : %s :: %s : %s, dist = %f, %d\n', ...
                get_relation_name(feat1, false), get_relation_name(feat2, false), ...
                get_relation_name(feat3, true), get_relation_name(feat4, true), false_dist, true_dist < false_dist);
            
            
            [false_dist, ABsortorder, CDsortorder, AB_murst, CD_murst] = ...
                analogy_importance_mapping(feat1_lower_mu, feat2_lower_mu, ...
                feat4_higher_mu, feat3_higher_mu, feat1_lower_sigma, feat2_lower_sigma, feat4_higher_sigma, feat3_higher_sigma);
            ...
            fprintf('%s : %s :: %s : %s, dist = %f\n', ...
                get_relation_name(feat1, false), get_relation_name(feat2, false), ...
                get_relation_name(feat4, true), get_relation_name(feat3, true), false_dist);
            
            fprintf(datafile, '%s : %s :: %s : %s, dist = %f, %d\n', ...
                get_relation_name(feat1, false), get_relation_name(feat2, false), ...
                get_relation_name(feat4, true), get_relation_name(feat3, true), false_dist, true_dist < false_dist);
